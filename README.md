...
[![Build Status](https://travis-ci.org/afayek1/atomapp.svg?branch=master)](https://travis-ci.org/afayek1/atomapp) [![Dependency Status](https://david-dm.org/afayek1/atomapp.svg)](https://david-dm.org/afayek1/atomapp) [![devDependency Status](https://david-dm.org/afayek1/atomapp/dev-status.svg)](https://david-dm.org/afayek1/atomapp#info=devDependencies)
...
## Release History
 * 2015-01-22   v0.1.0   Generated by the [Yeoman Generator](https://github.com/FamousTools/generator-famous) for [Famo.us](http://famo.us)